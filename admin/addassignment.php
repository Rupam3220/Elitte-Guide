                        ...
                        <div class="col-xl-7 col-lg-7 col-md-12">
                            <form action="uploadassignment.php" class="tm-edit-product-form" method="post" enctype="multipart/form-data">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <textarea class="form-control validate col-xl-9 col-lg-8 col-md-8 col-sm-7" name= "des"rows="3" required></textarea>
                                </div>
                                <div class="input-group mb-3">
                                   ...
                                   <input type= "text" name="notice_no" required>
									
                                </div>
								
                                 <div class="input-group mb-3">
                                    <label for="expire_date" name="num" class="col-xl-4 col-lg-4 col-md-4 col-sm-5 col-form-label" style="font-family:Comic Sans MS;">DATE
								 ...
								 <div class="input-group mb-3">
                                    ...
                                    <select class="custom-select col-xl-9 col-lg-8 col-md-8 col-sm-7" id="category" name = "year">
