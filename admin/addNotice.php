                        ...
                        <div class="col-xl-7 col-lg-7 col-md-12">
                            <form action="uploadnotice.php" class="tm-edit-product-form" method="post" enctype="multipart/form-data">
                                <div class="input-group mb-3">
                                    <label for="name" class="col-xl-4 col-lg-4 col-md-4 col-sm-5 col-form-label" style="font-family:Comic Sans MS;">Notice Name
                                    </label>
                                ...
                                <div class="input-group mb-3">
                                    <label for="category" class="col-xl-4 col-lg-4 col-md-4 col-sm-5 col-form-label" style="font-family:Comic Sans MS;">NOTICE NUMBER</label>
...
<option value="Automobile Engineering">Automobile Engineering</option>
                       ...
                       <div class="col-xl-4 col-lg-4 col-md-12 mx-auto mb-4" style="font-family:Comic Sans MS;">
                          
                            <div class="custom-file mt-3 mb-3" style="font-family:Comic Sans MS;">
                               
							   <input type='file' name='notice' required>
