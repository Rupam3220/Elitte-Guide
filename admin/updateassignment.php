...
{
$obj=new crud();
$res=$obj->fetch("SELECT * FROM assignment WHERE id=".$_GET['id']);
...
<head>
    ...
    <title>Add Assignment - Elitte Guide</title>
        ...
        <div class="row tm-mt-big">
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                <div class="bg-white tm-block">
                    <div class="row">
                        <div class="col-20">
                            <h2 class="tm-block-title d-inline-block" style="font-family:Comic Sans MS;">Add Assignment</h2>
                        </div>
                    </div>
                    <div class="row mt-6 tm-edit-product-row">
                        <div class="col-xl-7 col-lg-7 col-md-12">
                            <form action="uploadassignment.php" class="tm-edit-product-form" method="post" enctype="multipart/form-data">
                                <div class="input-group mb-3">
                                    <label for="name" class="col-xl-4 col-lg-4 col-md-4 col-sm-5 col-form-label" style="font-family:Comic Sans MS;">Assignment Name  
                                    </label>
                                    <input id="name" name="name" type="text" class="form-control validate col-xl-9 col-lg-8 col-md-8 col-sm-7" value="<?php echo $row['assignment_name'];?>" required>
                                </div>
                                <div class="input-group mb-3">
                                ...
                                <div class="input-group mb-3">
                                    <label for="category" class="col-xl-4 col-lg-4 col-md-4 col-sm-5 col-form-label" style="font-family:Comic Sans MS;">Assignment NUMBER</label>
                                   <input type= "text" name="notice_no" 
                                   value="<?php echo $row['assignment_no'];?>" required>
                                ...
                                <div class="input-group mb-3">
                                    <div class="ml-auto col-xl-8 col-lg-8 col-md-8 col-sm-7 pl-0">
                                        <button type="submit" name="add" class="btn btn-primary" style="font-family:Comic Sans MS;" required>Add  
                                        </button>
                                    </div>
                       ...
                       <div class="col-xl-4 col-lg-4 col-md-12 mx-auto mb-6">
                            ...
                            <div class="custom-file mt-3 mb-3" style="font-family:Comic Sans MS;" >
							   ...
							   <input type='file' name='assignment' value="<?php echo $_FILES["assignment"]["name"];?>" required>
