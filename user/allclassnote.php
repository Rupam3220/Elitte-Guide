...
<table class="table table-striped">
	<tr>
		...
		<td><strong>Classnote Name</strong></td>
		<td><strong>Description</strong></td>	
		<td><strong>Classnote Number</strong></td>	
...
<td><?php echo $row['classnote_name'] ?></td>
<td><?php echo $row['description'] ?></td>
<td><?php echo $row['classnote_no'] ?></td>
<td><?php echo $row['date'] ?></td>
<td><?php echo "<a href='/program/elitte_guide_final_project/admin/upload_classnote/".$row['file_path']."' target='_blank' >click</a>"; ?></td>
</tr>
<?php
}
?>
